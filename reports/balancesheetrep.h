...
public:
    ...
    void appendLineinTable(QString name, QString parent, int numberOfItems, float moneyOfItems, QString currency, float eurosOfItems, float wingsPercentage);
    void appendTotalPerDesignInTable(QString name, QString parent, int numberOfItems, float eurosOfItemsPerDesign, float wingsPercentage);
