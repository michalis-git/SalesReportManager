...
void ByCountryRep::appendLineinTable(QString name, QString country, int numberOfItems, float eurosOfItems, float companyPercentage) {
...
void ByCountryRep::appendTotalPerDesignInTable(QString name, int numberOfItems, float eurosOfItems, float companyPercentage) {
    ...
    mHtmlText2.append(str1 + "120" + str2 + QString::number(eurosOfItems * companyPercentage, 'f', 2) + "</strong></span></td>");
    mHtmlText2.append(str1 + "120" + str2 + QString::number((0.7 - companyPercentage)*100, 'f', 0) + "%</strong></span></td>");
    mHtmlText2.append(str1 + "120" + str2 + QString::number(eurosOfItems * (0.7 - companyPercentage), 'f', 2) + "</strong></span></td>");
}

void ByCountryRep::appendTotalOfReportInTable(int numberOfItems, float eurosOfItemsTotal, float companyRevenueTotal, float designerRevenueTotal) {
